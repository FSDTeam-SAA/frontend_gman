...
export default function Faq() {
  ...
  return (
    <div className="w-[1296px] mx-auto px-4 py-8 sm:px-6 lg:px-8 ">
      <div className=" mb-8 sm:mb-12">
        <h2 className="text-2xl sm:text-3xl lg:text-2xl font-bold text-[#272727] mb-2">Frequently Asked Questions</h2>
      </div>
          ...
          {faqs.map((faq) => (
            ...
            >
              <AccordionTrigger className="px-4 sm:px-6 py-4 sm:py-5 text-left hover:no-underline  transition-colors duration-200">
                <span className="text-sm sm:text-base lg:text-lg font-medium text-gray-900 pr-4">{faq.question}</span>
              </AccordionTrigger>
